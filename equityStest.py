...
def entry(signal: EntrySignal):
    ...
    # orderapi.place_mis_order_withsl(txntype=txtType, inst_symbol=instsymbol, qty=qty, stoploss=stoploss)
    orderapi.place_idx_order(txntype=txtType, inst_symbol=instsymbol, qty=qty, idxsymbol=idxsymbol, idxstoploss=stoploss, exchange=KiteConnect.EXCHANGE_NSE)
